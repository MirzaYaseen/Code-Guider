...
const MentorWelcome = () => {
    ...
    return (
        <div  style={{ height:670, backgroundColor:'#E6F7FF', alignSelf:'center', display:'flex', alignItems:'center', justifyContent:'center' }}>
            <div style={{ display: 'block', justifyContent: 'center', alignItems: 'center' }}>
                ...
                <div style={{  width: 800, height: 150, display: 'block', justifyContent: 'center', alignItems: 'center', marginLeft: 'auto', marginRight: 'auto', marginTop: 70 }}>
                    ...
                    <Button onClick={()=>navigate('/studentChooseLang')} style={{ backgroundColor: '#12486B', width: 300, height: 40, marginLeft: 'auto', marginRight: 'auto', display: 'flex', borderRadius:20, color:'white' }}>
                       Get Started
                    </Button>
                </div>
